...
"""
Gauss Seidel. Feito por Victor Martins
...
def seidel(A, b, epsilon, n, limite=50):
    ...
    for k in range(1, limite + 1):
        ...
        # modificado e o atual virará o anterior. Uso slice para fazer uma
        # cópia sem ser por referência em python.
        v = x[:]
...
if (escolha == 1):
    ...
    for i in range(n):
        ...
        x = seidel(deepcopy(matriz), vetor_identidade, tol, n)
...
# CÁLCULO DO VETOR d PELA MATRIZ ORIGINAL #
    ...
    x = seidel(deepcopy(matriz), b, tol, n)
